...
const upload = {
  single: async (file: Promise<FileUpload>, destination: string): Promise<string | undefined> => {
  ...
  multiple: async (files: [Promise<FileUpload>], destination: string, max?: number): Promise<string[] | undefined[]> => {
